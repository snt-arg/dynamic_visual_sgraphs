...
namespace ORB_SLAM3
{
    ...
    // Semantic Entities
    std::vector<MapPoint *> Tracking::findPointsCloseToMarker(const Marker *currentMarker)
    {
        // Get all map points
        ...
        std::vector<MapPoint *> closePoints =
            findPointsCloseToLocation(allmapPoints, currentMarker->getGlobalPose().translation(), 0.1);
